...
import 'package:googlemap_testapp/components/user.dart';
import 'package:googlemap_testapp/components/seller-navbar.dart';
...
class _FlutterMapScreenState extends State<FlutterMapScreens> {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                        width:
                                            13.0), // Add spacing between icons and distance
                                    Column(
                                      crossAxisAlignment:
                                          CrossAxisAlignment.start,
                                      children: [
                                        SizedBox(height: 5.0),
                                        Text(
                                          storeInfo['distance'].split(" ")[
                                              0], // Extract distance number
                                          style: TextStyle(
                                              fontSize: 24.0,
                                              color: Color(0xFF28666E),
                      ...
                      SizedBox(
                          height:
                              10.0), // Add space between store details and product list
                      Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 20.0),
                        child: Text(
                          'Available Products',
                      ...
                      SizedBox(
                          height:
                              10.0), // Add space between "Available Products" and product list
                      Container(
                        padding: EdgeInsets.symmetric(horizontal: 20.0),
                        child:
                            buildProductList(products ?? [], _currentLocation),
                      ),
                    ],
                  ),
                ),
  ...
  Widget build(BuildContext context) {
    //final userRole = Provider.of<UserRoleProvider>(context).currentUser?.role;
    return Scaffold(
      appBar: AppBar(
          ...
          Align(
            ...
            child: Consumer<UserRoleProvider>(
              builder: (context, userProvider, _) {
                final String role = userProvider.currentRole ?? 'guest';
